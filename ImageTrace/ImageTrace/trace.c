...
point_t dorth_infty(dpoint_t p0, dpoint_t p2) {
  point_t r;
...
double dpara(dpoint_t p0, dpoint_t p1, dpoint_t p2) {
  double x1, y1, x2, y2;
...
double ddenom(dpoint_t p0, dpoint_t p2) {
...
double quadform(quadform_t Q, dpoint_t w) {
  double v[3];
  int i, j;
  double sum;
...
/* calculate p1 x p2 */
int xprod(point_t p1, point_t p2) {
  return p1.x*p2.y - p1.y*p2.x;
}

/* calculate (p1-p0)x(p3-p2) */
double cprod(dpoint_t p0, dpoint_t p1, dpoint_t p2, dpoint_t p3) {
  double x1, y1, x2, y2;
...
double iprod(dpoint_t p0, dpoint_t p1, dpoint_t p2) {
  double x1, y1, x2, y2;
...
double iprod1(dpoint_t p0, dpoint_t p1, dpoint_t p2, dpoint_t p3) {
  double x1, y1, x2, y2;
...
double ddist(dpoint_t p, dpoint_t q) {
